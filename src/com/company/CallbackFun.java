...
public class CallbackFun {
    public static void main(String[] args) {
        try {
            ...
            // MQTT设置说明
            mqtt.setHost("tcp://192.168.0.1:1883");
...
//            mqtt.setCleanSession(false); // 若设为false，MQTT服务器将持久化客户端会话的主体订阅和ACK位置，默认为true
            ...
            // 选择消息分发队列
            mqtt.setDispatchQueue(Dispatch.createQueue("hello/world"));// 若没有调用方法setDispatchQueue，客户端将为连接新建一个队列。如果想实现多个连接使用公用的队列，显式地指定队列是一个非常方便的实现方法
            ...
            callbackConnection.connect(new Callback<Void>() {
                ...
                public void onSuccess(Void v) {
                    ...
                    // 发布消息
                    callbackConnection.publish("hello/world", ("Hello ").getBytes(),
